<footer id="footer" class="border-0 mt-0">
  <div class="container py-5">
    <div class="row py-3">
      <div class="col-md-4 mb-5 mb-md-0">
        <div class="feature-box flex-column flex-xl-row align-items-center align-items-lg-start text-center text-lg-start">
          <div class="feature-box-icon bg-transparent mb-4 mb-xl-0 p-0">
            <img width="45" src="{{asset('Frontend/img/demos/auto-services/icons/icon-location.svg')}}" alt="" data-icon data-plugin-options="{'onlySVG': true, 'extraClass': 'svg-fill-color-light position-relative bottom-3'}" />
          </div>
      ...
      <div class="col-md-4">
        <div class="feature-box flex-column flex-xl-row align-items-center align-items-lg-start text-center text-lg-start">
          <div class="feature-box-icon bg-transparent mb-4 mb-xl-0 p-0">
            <img width="45" src="{{asset('Frontend/img/demos/auto-services/icons/car-winch.svg')}}" alt="" data-icon data-plugin-options="{'onlySVG': true, 'extraClass': 'svg-fill-color-light position-relative bottom-3'}" />
          </div>
    ...
    <div class="row text-center text-md-start py-4 my-5">
      <div class="col-md-6 col-lg-3 align-self-center text-center text-md-start text-lg-center mb-5 mb-lg-0">
        <a href="#" class="text-decoration-none">
          <img src="{{asset('Frontend/img/demos/auto-services/logo-light.png')}}" class="img-fluid" alt="" />
        </a>
      </div>
      ...
      <div class="col-md-6 col-lg-2 mb-5 mb-md-0">
        ...
        <ul class="list list-unstyled mb-0">
          <li class="mb-0"><a href="#">Brake Repair</a></li>
          <li class="mb-0"><a href="#">Check Engine</a></li>
          <li class="mb-0"><a href="#">Suspension Repair</a></li>
          <li class="mb-0"><a href="#">Transmission Repair</a></li>
          <li class="mb-0"><a href="#">A/C Repair</a></li>
          <li class="mb-0"><a href="#">Oil Change</a></li>
          <li class="mb-0"><a href="#">Electrical Diagnostics</a></li>
          <li class="mb-0"><a href="#">Tune Up</a></li>
          <li class="mb-0"><a href="#">Fuel System Repair</a></li>
        </ul>
      </div>
  ...
  <div class="footer-copyright bg-light py-4">
    <div class="container py-2">
      <div class="row">
        <div class="col">
          <p class="text-center text-3 mb-0">Porto Auto Services © 2022. All Rights Reserved.</p>
        </div>
      </div>
    </div>
  </div>
